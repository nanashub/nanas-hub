        ...
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div>
              ...
              <p className="text-xs text-[#6B5F58] mt-1">If you already use Acuity, Square, Fresha, or Calendly, paste your booking link here. Clients will book through your existing system.</p>
            </div>
